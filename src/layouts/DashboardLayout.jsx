                    ...
                    <ul className="menu w-full grow">
...

                        {
                            role === 'admin' && <>
                                ...
                                <li>
                                    <NavLink className="is-drawer-close:tooltip is-drawer-close:tooltip-right" data-tip="User ManageMent" to="/dashboard/users-management">
                                        <BiUser />
                                        <span className="is-drawer-close:hidden">My User ManageMent</span>
                                    </NavLink>
                                </li>
